...
class ControllerToolImportYml extends Controller
{
    ...
    private $data_mapping = array(
        'product_description' => '$product_description',
        'product_special' => 'array ()',
        'product_store' => 'array(0)',
        'main_category_id' => '$id_category',
        'product_category' => 'array ($id_category)',
        ...
        for ($i = $start; $i < $n; ++$i) {
            ...
            foreach ($languages as $language) {
                $product_description[ $language['language_id'] ] = array(
                    ...
                    'description' => (sizeof($offer->xpath('param[@name="HTML описание"]'))) == 0 ? (string) $offer->description : $offer->xpath('param[@name="HTML описание"]')[0],
                    'tag' => '',
            ...
            $data_mapping_keys = array_keys($this->data_mapping);
            foreach ($data_mapping_keys as $key) {
                $command = $this->data_mapping[$key];
            ...
            if (isset($offer->param)) {
                $params = $offer->xpath('param[@name!="HTML описание"]');
